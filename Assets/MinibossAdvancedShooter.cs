...
public class MinibossAdvancedShooter : MinibossBase
{
    public enum State
    {
        GoToGameArea,
    ...
    {
        CurrentPoint = new Vector3(_transform.position.x, GameManager.instance.Player.transform.position.y + 0.8f, 0);
    }
