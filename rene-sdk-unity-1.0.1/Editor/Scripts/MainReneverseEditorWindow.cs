...
public class MainReneverseEditorWindow : EditorWindow
{
    ...
    {
        get { return SessionState.GetBool(PrefKeyIsConnected, _isConnected); }
        private set
        {
            _isConnected = value;
    ...
    private void OnGUI()
    {
        ...
        if (gameDataContainer.IsGameDataAvailable)
        {
    ...
    private static void ShowAdSurfacesAndAssets(GameRelatedPersistentData gameDataContainer)
    {
        ...
        AssetTemplatesFoldout.Instance.AssetsFoldouts
            ("No ownable or branded assets found in your account", gameDataContainer);
    }
    ...
    private GameRelatedPersistentData _gameDataContainer;

    private GameRelatedPersistentData gameDataContainer
    {
        get
        {
            if (_gameDataContainer == null)
            {
                _gameDataContainer = Helper.LoadAndGetGameRelatedPersistentData;
            }

            return _gameDataContainer;
        }
        set { _gameDataContainer = value; }
    }
